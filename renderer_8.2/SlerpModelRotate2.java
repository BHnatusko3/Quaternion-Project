...
Course: CS 42000
      ...
      Clicking and dragging projects a mouse onto
      a hypothetical unit sphere around the origin,
      rotating that sphere and the model.
*/
...
*/
public class SlerpModelRotate2
{
   ...
   private Spot3D lastPos = new Spot3D(0,0,0);
   private Spot3D currentPos = new Spot3D(0,0,0);
