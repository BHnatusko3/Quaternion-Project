...
/**
   Rotate the unit square around its lower right-hand corner.
<p>
...
<p>
   See the animation <a href="../Example_06.gif">Example_06.gif</a>.
<p>
   <a href="../Example_06.gif"><img src="../Example_06.gif" alt="Example_06.gif"></a>
<p>
   Be sure to compare this animation to {@link Example_02}.
<p>
   For the i'th frame of the animation, the square's model matrix is
   <pre>{@code
      M = T(1, 0, 0) * R(6*i) * T(-1, 0, 0)
   }</pre>
<p>
...
public class Example_06
{
   public static void main(String[] args)
   {
      ...
      position3.matrix = Matrix.translate(-1, 0, 0);
      ...
      for (int i = 0; i < 60; i++)
      {
         ...
         fb.dumpFB2File(String.format("PPM_Example_06_Frame%03d.ppm", i));
