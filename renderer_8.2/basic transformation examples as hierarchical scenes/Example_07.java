...
/**
   ...
   rotation at the point (1/4, 1/4) in the camera's view
   coordinate system.
<p>
...
<p>
   ...
   <pre>{@code
      M = T(1/4, 1/4, 0) * R(6*i) * T(-3/4, -3/4, 0)
   }</pre>
<p>
...
public class Example_07
{
   public static void main(String[] args)
   {
      ...
      position3.matrix = Matrix.translate(-0.75, -0.75, 0);

      // Translate it back.
      position1.matrix.mult( Matrix.translate(0.25, 0.25, 0) );
      ...
      for (int i = 0; i < 60; i++)
      {
         ...
         fb.dumpFB2File(String.format("PPM_Example_07_Frame%03d.ppm", i));
