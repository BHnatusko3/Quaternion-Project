...
<p>
   ...
   in the middle of the position's matrix expression, this example was
   a bit more difficult to implement with Renderer 6.
   <pre>{@code
             Scene
            /     \
           /       \
...
public class Example_05
{
   public static void main(String[] args)
   {
      ...
      // Translate it back.
      position1.matrix.mult( Matrix.translate(1, 1, 0) );
      ...
      for (int i = 0; i < 60; i++)
      {
         ...
         fb.dumpFB2File(String.format("PPM_Example_05_Frame%03d.ppm", i));
